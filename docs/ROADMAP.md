...
2. [#20 — Stage 1B typed semantic confidence](https://github.com/CasterlyGit/cognitive-development-os/issues/20), stacked for linear review but independently testable
