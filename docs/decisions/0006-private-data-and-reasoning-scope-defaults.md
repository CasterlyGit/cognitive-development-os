...
seven-day recovery window. The plan verifies each source in the local ledger and
binds its structural content digest. It is reversible and effect-free.
Irreversible purge is deliberately unimplemented and requires a separate exact
human action.
