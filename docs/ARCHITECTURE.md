...
| Session-private content and structural lineage | [#30](https://github.com/CasterlyGit/cognitive-development-os/issues/30) | implemented — review gate | v2 path only; legacy data is unchanged |
