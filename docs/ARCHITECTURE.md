...
| Private-data and reasoning defaults | [#26](https://github.com/CasterlyGit/cognitive-development-os/issues/26) | implemented — review gate | Policy/audit only; legacy embedded data requires migration |
